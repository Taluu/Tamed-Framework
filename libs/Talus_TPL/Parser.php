...
class Parser implements Interfaces\Parser {
  ...
  protected function _filters($var = '', $filters = '', $type = null){
    ...
    foreach ($filters as &$filter) {
      ...
      if (!method_exists('Filters', $fct)){
        trigger_error("The filter \"$fct\" does not exists, and thus shall be ignored.\n\n",
                      E_USER_NOTICE);
        continue;
      }
      ...
      $return = sprintf('Filters::%1$s(%2$s%3$s)', $fct, $return, $params);
    }
